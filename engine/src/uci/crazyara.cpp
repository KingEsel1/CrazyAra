...
void CrazyAra::uci_loop(int argc, char* argv[])
{
    ...
    vector<string> commands = {
        ...
        //"setoption name Milli_Novelty_Decay value 10",
        //"setoption name Milli_Novelty_Value value 100",
        //"setoption name Search_Type value mcts",
        //"setoption name Novelty_Type value pseudo",
